...
impl PrintProgramError for EscrowError {
            ...
            + num_traits::FromPrimitive,
    {
        match self {
            ...
            EscrowError::InvalidOutputOwner => {
            ...
            EscrowError::EmptySupply => msg!("Error: Input token account empty"),
            EscrowError::InvalidSupply => msg!("Error: Pool token mint has a non-zero supply"),
            EscrowError::RepeatedMint => {
                msg!("Error: Swap input token accounts have the same mint")
            }
            EscrowError::InvalidDelegate => msg!("Error: Token account has a delegate"),
            ...
            EscrowError::IncorrectPoolMint => {
                msg!("Error: Address of the provided pool token mint is incorrect")
            }
            EscrowError::InvalidOutput => msg!("Error: InvalidOutput"),
            EscrowError::CalculationFailure => msg!("Error: CalculationFailure"),
            EscrowError::InvalidInstruction => msg!("Error: InvalidInstruction"),
            EscrowError::ExceededSlippage => {
                msg!("Error: Swap instruction exceeds desired slippage limit")
            }
            EscrowError::InvalidCloseAuthority => {
                msg!("Error: Token account has a close authority")
            }
            EscrowError::InvalidFreezeAuthority => {
                msg!("Error: Pool token mint has a freeze authority")
            }
            EscrowError::IncorrectFeeAccount => msg!("Error: Pool fee token account incorrect"),
            EscrowError::ZeroTradingTokens => {
                msg!("Error: Given pool token amount results in zero trading tokens")
            }
            EscrowError::FeeCalculationFailure => msg!(
